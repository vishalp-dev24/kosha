  ...
  return (
    <>
      ...
      <div className="grid gap-6 xl:grid-cols-[0.85fr_1.15fr]">
        <section className="rounded-[1.75rem] border border-paper/10 bg-paper/7 p-5">
          ...
          <div className="mt-5 grid gap-3">
            {onboardingSteps.map((step, index) => (
              <article key={step.title} className="flex gap-4 rounded-2xl border border-paper/10 bg-ink p-4">
        ...
        <section className="rounded-[1.75rem] border border-paper/10 bg-paper/7 p-5">
          <div className="grid h-full place-items-center rounded-[1.25rem] border border-dashed border-paper/16 bg-ink p-8 text-center">
