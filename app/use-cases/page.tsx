      ...
      <main className="mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-24">
        ...
        <MotionSection className="mt-12 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {useCases.map((useCase) => {
            ...
            return (
              <article key={useCase.title} className="group rounded-[1.75rem] border border-line bg-white/62 p-6 transition hover:-translate-y-1 hover:border-blue/35 hover:shadow-ledger">
                ...
                <div className="mt-6 rounded-2xl border border-line/70 bg-paper/72 p-4 text-sm font-semibold text-ink/72">
        ...
        <MotionSection className="mt-16 rounded-[2rem] bg-ink p-6 text-paper md:p-10">
